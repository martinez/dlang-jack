...
enum JACK_PARAM_MAX = jackctl_param_type_t.JackParamBool + 1;

/** @brief Max length of string parameter value, excluding terminating null char */
enum JACK_PARAM_STRING_MAX = 127;
...
jackctl_server_create(
    bool function(const(char) * device_name) on_device_acquire,
    void function(const(char) * device_name) on_device_release);
...
jackctl_parameter_set_value(
	jackctl_parameter_t * parameter,
	const(jackctl_parameter_value) * value_ptr);
...
jackctl_parameter_get_range_constraint(
	jackctl_parameter_t * parameter,
	jackctl_parameter_value * min_ptr,
